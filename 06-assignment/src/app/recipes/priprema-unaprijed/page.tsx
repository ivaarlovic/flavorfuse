...
const PripremaUnaprijedPage = () => {
  ...
  useEffect(() => {
    client.getEntries({ content_type: 'recept' })
      .then((response) => {
        ...
        .filter((item) => Array.isArray(item.fields.kategorija) && item.fields.kategorija.some((kat) => kat === 'Jela za pripremu unaprijed'))
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold text-center mb-6">Jela za pripremu unaprijed</h1>
...
export default PripremaUnaprijedPage;